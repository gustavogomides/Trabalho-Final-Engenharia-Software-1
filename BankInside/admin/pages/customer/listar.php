									...
									<table class="table table-striped table-bordered " id="sample_1">
										...
										<tbody>
											<?php
				                                ...
				                                $listar = mysqli_query($mysqli, "SELECT idCustomer, name, gender, birthday,
				                                										address, documentID
				                                                                        FROM customer
				                                ...
				                                if(@mysqli_num_rows($listar) <= '0'){
				                                    ...
				                                    while($res_listar = mysqli_fetch_array($listar)){
				                                        ...
				                                        $nome = $res_listar[1];
				                                        $sexo = $res_listar[2];
				                                        $dataNasc = new DateTime($res_listar[3]);		
				                                        $endereco = $res_listar[4];
				                                        $documento = $res_listar[5];
											...
											<tr class="odd gradeX">
												...
												<td class="hidden-phone"><?php echo date_format($dataNasc, "j F, Y"); ?></td>
												<td class="hidden-phone"><?php echo $endereco; ?></td>
												<td class="hidden-phone"><?php echo $documento; ?></td>
												<td class="hidden-phone">
													<a href="index.php?topicos=pages/customer/visualizar&id=<?php echo $id; ?>">
														<button class="btn">
															<i class="icon-eye-open"></i> Visualizar Cliente
														</button>
													</a>
												</td>
