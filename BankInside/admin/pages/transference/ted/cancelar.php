			...
			<div class="main-content">
				<div class="container">
					<div class="row">
						<h3 class="page-title">Cancelar TED</h3>
							<ul class="breadcrumb">
								<li><a href="#"><i class="icon-flag"></i></a><span class="divider">&nbsp;</span></li>
								<li><a href="#">TED</a><span class="divider">&nbsp;</span></li>
								<li><a href="index.php?topicos=pages/transference/ted/listarTED">Lista de TEDs</a><span class="divider">&nbsp;</span></li>
								<li><a href="index.php?topicos=pages/transference/ted/visualizar&id=<?php echo $pega_id; ?>">Visualizar TED</a><span class="divider">&nbsp;</span></li>
								<li><a href="#">Cancelar TED</a><span class="divider-last">&nbsp;</span></li>
							</ul>
								...
								<form class="form-horizontal" nome="editar" action="" method="post" enctype="multipart/form-data">
									<?php 
						                    if(isset($_POST['editar']) && $_POST['editar'] == 'edit'){
													...
													$editarDestinatário = mysqli_query($mysqli, "UPDATE account
						                                                                SET balance = balance - '$valor'
																						WHERE idAccount = '$destinatario'
						                                                                LIMIT 1")
					                    									or die(mysqli_error($mysqli));
					                    			...
					                    			$atualizaContadorDestinatário = mysqli_query($mysqli, "UPDATE account
						                                                             SET counter = counter + 1
																					 WHERE idAccount = '$destinatario'
						                                                             LIMIT 1")
					                    										or die(mysqli_error($mysqli));
					                    			...
					                    			$atualizaDataDestinatario = mysqli_query($mysqli, "UPDATE account
						                        ...
						                        if($editar == '1'){
													...
													<strong>Sucesso!</strong> TED cancelado com sucesso! 
													...
													<button class="close" data-dismiss="alert">×</button>
													<strong>Erro!</strong>O cancelamento do TED falhou!
													Tente novamente!
													</div>';
						                        }
						                	}   
									...
									<div class="form-group"> <!-- inicio do grupo -->
										<div class="form-actions"><!-- inicio do grupo-->
												<button type="submit" name="senderTime" class="btn btn-primary btn-lg">Cancelar TED</button>
												<button type="button" class="btn btn-lg" onclick="window.location='index.php?topicos=pages/transference/ted/visualizar&id=<?php echo $pega_id; ?>';">Voltar</button>
										</div>
									</div><!-- fim do grupo-->
