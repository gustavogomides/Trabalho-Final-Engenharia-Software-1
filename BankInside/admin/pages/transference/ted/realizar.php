								...
								<form class="form-horizontal" nome="cadastrar" action="" method="post" enctype="multipart/form-data">
									<?php 
										if(isset($_POST['cadastrar']) && $_POST['cadastrar'] == 'cad') {
											...
											$cadastrar = mysqli_query($mysqli, 
												...
												VALUES ('TED', '$valor', '$dataTED', '$pega_id', 'BankInside', '$IDconta')")
												or die(mysqli_error($mysqli)); 
			                    			...
			                    			if($cadastrar == '1'){
													...
													<strong>Sucesso!</strong> TED realizado com Sucesso! 
												...
												<button class="close" data-dismiss="alert">×</button>
												<strong>Erro!</strong>TED não realizada!
												Tente novamente!
												</div>';
											}
									...
									<div class="form-group"><!-- inicio do grupo-->
										<div class="form-actions">
											<button type="submit" name="senderTime" class="btn btn-primary btn-lg">Realizar TED</button>
											<button type="button" class="btn btn-lg" onclick="window.location.href='index.php?topicos=pages/transference/ted/opcao'">Cancelar</button>
										</div>
									</div><!-- fim do grupo-->
