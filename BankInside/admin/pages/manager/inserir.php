			<div class="main-content">
				<div class="container">
					<div class="row">
						<h3 class="page-title">Inserir Gerente</h3>
								...
								<form class="form-horizontal" nome="cadastrar" action="" method="post" enctype="multipart/form-data">
									<?php 
										if(isset($_POST['cadastrar']) && $_POST['cadastrar'] == 'cad') {
											...
											"INSERT INTO manager(name, gender, address, documentId, id_user)
											VALUES ('$nome', '$sexo', '$endereco', '$documento', '$atualizaUser')")
											or die(mysqli_error($mysqli)); 

											if($cadastrar == '1'){
											echo '<div class="alert alert-success">
											<button class="close" data-dismiss="alert">×</button>
											<strong>Sucesso!</strong> Gerente cadastrado com sucesso! 
											...
											<button class="close" data-dismiss="alert">×</button>
											<strong>Erro!</strong>O cadastro do Gerente falhou!
											Tente novamente!
											</div>';
											}
									...
									<div class="form-group"><!-- inicio do grupo-->
										<div class="form-actions">
											<button type="submit" name="senderTime" class="btn btn-primary btn-lg">Cadastrar Gerente</button>
